            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h3>Province List Management</h3>
                </div>
            ...
            <div class="row">
             ...
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $service->query("select * from tbl_state");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_state.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
