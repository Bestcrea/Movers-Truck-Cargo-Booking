              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
				  ...
				  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0);">
                      ...
                      </svg><span>State</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="add_state.php">Add State</a></li>
                      <li><a href="list_state.php">List States</a></li>
                    </ul>
                  </li>
				  
				   <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0);">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7 19C8.10457 19 9 18.1046 9 17C9 15.8954 8.10457 15 7 15C5.89543 15 5 15.8954 5 17C5 18.1046 5.89543 19 7 19Z" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M17 19C18.1046 19 19 18.1046 19 17C19 15.8954 18.1046 15 17 15C15.8954 15 15 15.8954 15 17C15 18.1046 15.8954 19 17 19Z" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M5 17H3V13M2 5H13V17M9 17H15M19 17H21V11H13M13 6H18L21 11M3 9H7" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
<span>Vehicle</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="add_vehicle.php">Add Vehicle</a></li>
                      <li><a href="list_vehicle.php">List Vehicle</a></li>
                    </ul>
                  </li>
...
<path d="M8.0001 3H9.0001C7.0501 8.84 7.0501 15.16 9.0001 21H8.0001" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
<span>Country Code</span></a>
				  ...
				  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0);">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 6V8.42C22 10 21 11 19.42 11H16V4.01C16 2.9 16.91 2 18.02 2C19.11 2.01 20.11 2.45 20.83 3.17C21.55 3.9 22 4.9 22 6Z" stroke="#111827" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M2 7V21C2 21.83 2.93998 22.3 3.59998 21.8L5.31 20.52C5.71 20.22 6.27 20.26 6.63 20.62L8.28998 22.29C8.67998 22.68 9.32002 22.68 9.71002 22.29L11.39 20.61C11.74 20.26 12.3 20.22 12.69 20.52L14.4 21.8C15.06 22.29 16 21.82 16 21V4C16 2.9 16.9 2 18 2H7H6C3 2 2 3.79 2 6V7Z" stroke="#111827" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M6 9H12" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M6.75 13H11.25" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
<span>Page</span></a>
                    <ul class="sidebar-submenu">
...
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.5 19H8C4 19 2 18 2 13V8C2 4 4 2 8 2H16C20 2 22 4 22 8V13C22 17 20 19 16 19H15.5C15.19 19 14.89 19.15 14.7 19.4L13.2 21.4C12.54 22.28 11.46 22.28 10.8 21.4L9.3 19.4C9.14 19.18 8.77 19 8.5 19Z" stroke="#111827" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M7 8H17" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M7 13H13" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
...
<!-- Generator: Adobe Illustrator 19.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22.9999 17.91C23.0199 18.66 22.8199 19.37 22.4599 19.98C22.2599 20.34 21.9899 20.6701 21.6899 20.9401C20.9999 21.5801 20.0899 21.9701 19.0799 22.0001C17.6199 22.0301 16.3299 21.2801 15.6199 20.1301C15.2399 19.5401 15.0099 18.8301 14.9999 18.0801C14.9699 16.8201 15.5299 15.6801 16.4299 14.9301C17.1099 14.3701 17.9699 14.0201 18.9099 14.0001C21.1199 13.9501 22.9499 15.7 22.9999 17.91Z" stroke="#111827" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M17.4399 18.03L18.45 18.99L20.5399 16.97" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M3.17017 7.43994L12.0002 12.5499L20.7701 7.46991" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12.0002 21.6099V12.5399" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M21.6101 9.17V14.83C21.6101 14.88 21.6101 14.92 21.6001 14.97C20.9001 14.36 20.0001 14 19.0001 14C18.0601 14 17.1901 14.33 16.5001 14.88C15.5801 15.61 15.0001 16.74 15.0001 18C15.0001 18.75 15.2101 19.46 15.5801 20.06C15.6701 20.22 15.7801 20.37 15.9001 20.51L14.0701 21.52C12.9301 22.16 11.0701 22.16 9.93011 21.52L4.59012 18.56C3.38012 17.89 2.39014 16.21 2.39014 14.83V9.17C2.39014 7.79 3.38012 6.11002 4.59012 5.44002L9.93011 2.48C11.0701 1.84 12.9301 1.84 14.0701 2.48L19.4101 5.44002C20.6201 6.11002 21.6101 7.79 21.6101 9.17Z" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

<span>Load Order</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="pending.php">Pending Order</a></li>
                      <li><a href="accepted.php">Accepted Order</a></li>
					  <li><a href="pickup.php">Pick Up Order</a></li>
...
<span>Transporter list</span></a></li>
				  
				  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="ownerlist.php">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g> 
                      <g> 
                  ...
                  </svg><span>Lorry Owner list</span></a></li>
				  
				  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="lorrylist.php">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12 14C13.1046 14 14 13.1046 14 12C14 10.8954 13.1046 10 12 10C10.8954 10 10 10.8954 10 12C10 13.1046 10.8954 14 12 14Z" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M14 12L20.75 10M12 14V21V14ZM10 12L3.25 10L10 12Z" stroke="#111827" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
<span>Lorry list</span></a></li>
...
<span>Setting</span></a></li>
                ...
                <!--<div class="sidebar-img-section">
                  <div class="sidebar-img-content"><img class="img-fluid" src="assets/images/side-bar.png" alt="">
                    <h4>Need Help ?</h4><a class="btn btn-secondary" href="https://join.skype.com/invite/UaLkm7W1aZey">Contact Now</a>
                  </div>
                </div>-->
              </div>
