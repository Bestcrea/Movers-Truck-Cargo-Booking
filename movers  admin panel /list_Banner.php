            ...
            <div class="row">
             ...
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $service->query("select * from banner");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
                                                ...
                                                <td class="align-middle">
                                                   <img src="<?php echo $row['img']; ?>" width="180" height="100"/>
                                                </td>
												
                                                <?php if($row['b_type'] == 1) { ?>
												
                                                <td><span class="badge badge-info">Transporter</span></td>
												<?php } else { ?>
												
												<td>
												<span class="badge badge-info">Lorry Owner</span></td>
												<?php } ?>
